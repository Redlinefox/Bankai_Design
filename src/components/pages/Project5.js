      ...
      <div className='project-info-container'>
        ...
        <div className='project-row'>
          ...
          <div className='project-text'>
            <p>
              This is an overview of our process when we were tasked with designing a big idea
              for the Plano based technology company C-Hear.
            </p>
          </div>
        </div>
        <div className='project-row'>
          ...
          <div className='project-text'>
            <p>
              C-Hear's CHIF technology and it's capabilities gave it distinguishing features compared
              ...
              leverage all of these qualities.
            </p>
          </div>
        </div>
        <div className='project-row'>
          ...
          <div className='project-text'>
            <p>
              Combining block-chain technology with the CHIF to produce a collectible card system for
              the music industry; something which doesn't exist as of yet.
            </p>
          </div>
        </div>
        <div className='project-row'>
